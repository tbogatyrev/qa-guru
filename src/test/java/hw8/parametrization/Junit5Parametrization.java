...
// Расчет суммы платежа в зависимости от срока кредита
// * потворить для тестовых данных: [1 год, 118 900 ₽; 2 года, 62 500 ₽, 3 года, 43 800 ₽]

// Открыть страницу Альфа-Банка
// Нажать на кнопку срока кредита {test_data}
// проверить, что расчет ежемесячно платежа отображается корректно {expected}
